...
class GeneralController
{
    ...
    {
        $_SESSION['message'] = "<p class='success-message fs-5 text-center'><img src='/assets/images/icons/success-icon.png' alt='success icon' style='margin-top:-5px;'> $message</p>";
    ...
    {
        $_SESSION['message'] = "<p class='error-message fs-5 text-center'><img src='/assets/images/icons/error-icon.png' alt='error icon'  style='margin-top:-5px;'> $error</p>";
        exit(header("Location: $path"));
    }
